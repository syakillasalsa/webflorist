...
Route::get('/admin/transactions', [TransactionController::class, 'adminIndex'])->middleware('auth')->name('transactions.admin_index');
...
Route::get('/transactions/{id}/nota', [TransactionController::class, 'showInvoice'])->name('transactions.showInvoice');
